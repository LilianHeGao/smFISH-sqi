...
REM Fix for OpenMP conflict between PyTorch and Intel MKL on Windows
...
set OUT_ROOT=output\022425_FTD_smFISH_MBP_NRGN\coverslip2_FTD_group1\MBP_NRGN_set1
set FOV_NUM=10
